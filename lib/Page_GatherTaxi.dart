        ...
        children: [
          ListView(
            children: [
              ...
              PointContainer(),
              SizedBox(height: 16),
              ChattingRoomList(1, '서현가실 분', '외대 -> 서현', '', 3, '18:25'),
              ChattingRoomList(1, '테스트1', '장소 입력', '', 7, '12:34'),
              ChattingRoomList(1, '테스트2', '장소 입력', '', 7, '12:34'),
              ChattingRoomList(1, '테스트3', '장소 입력', '', 7, '12:34'),
              ChattingRoomList(1, '테스트4', '장소 입력', '', 7, '12:34'),
              ChattingRoomList(1, '테스트5', '장소 입력', '', 7, '12:34'),
            ],
          ),
