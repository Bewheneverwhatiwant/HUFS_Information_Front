    ...
    return Row(
      ...
      children: [
        ...
        Checkbox(
          onChanged: (value) {
            setState(() {
              isFirstCheckBoxChecked = true; //기본적으로 글로벌캠퍼스의 메뉴 목록이 먼저 보이도록 함
  ...
  Row WhichMenu() {
    return Row(
      ...
      children: [
        ...
        SizedBox(width: 30),
        Text('조식', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
          ],
        ),
      ...
      Row(
        ...
        SizedBox(width: 30),
        Text('중식', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
        ],
      ),
       Row(
        children: [
        ...
        SizedBox(width: 30),
        Text('석식', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
        ],
      ),
      ],
    );
...
Widget WhichTimeMenuContainer() {
  ...
  Widget global_MorningMenu() {
    return Container(
      child: Column(
        children: [
              MenuContainer(2, '글로벌 조식', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(3, '수육국밥', '쌀밥, 수육국밥, 부추무침, 단무지', '11:00~14:30', '후생관 교직원식당', 4900),
              MenuContainer(2, '테스트1', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(4, '테스트2', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트3', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트4', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트5', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트6', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900)
        ],
      ),
    );
  }
  ...
  Widget global_AfternoonMenu() {
    return Container(
      child: Column(
        children: [
              MenuContainer(2, '글로벌 중식', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(3, '수육국밥', '쌀밥, 수육국밥, 부추무침, 단무지', '11:00~14:30', '후생관 교직원식당', 4900),
              MenuContainer(2, '테스트1', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(4, '테스트2', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트3', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
  ...
  Widget global_NightMenu() {
    return Container(
      child: Column(
        children: [
              MenuContainer(2, '글로벌 석식', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(3, '수육국밥', '쌀밥, 수육국밥, 부추무침, 단무지', '11:00~14:30', '후생관 교직원식당', 4900),
              MenuContainer(2, '테스트1', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(4, '테스트2', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트3', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
  ...
  Widget seoul_MorningMenu() {
    return Container(
      child: Column(
        children: [
              MenuContainer(2, '서울 조식', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(3, '수육국밥', '쌀밥, 수육국밥, 부추무침, 단무지', '11:00~14:30', '후생관 교직원식당', 4900),
              MenuContainer(2, '테스트1', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(4, '테스트2', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트3', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
  ...
  Widget seoul_AfternoonMenu() {
    return Container(
      child: Column(
        children: [
              MenuContainer(2, '서울 중식', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(3, '수육국밥', '쌀밥, 수육국밥, 부추무침, 단무지', '11:00~14:30', '후생관 교직원식당', 4900),
              MenuContainer(2, '테스트1', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(4, '테스트2', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트3', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
  ...
  Widget seoul_NightMenu() {
    return Container(
      child: Column(
        children: [
              MenuContainer(2, '서울 석식', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(3, '수육국밥', '쌀밥, 수육국밥, 부추무침, 단무지', '11:00~14:30', '후생관 교직원식당', 4900),
              MenuContainer(2, '테스트1', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(4, '테스트2', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
              MenuContainer(2, '테스트3', '쌀밥, 등심돈까스, 치커리무침, 단무지', '11:00~14:30', '후생관 학생식당', 4900),
...
Padding MenuContainer(int type, String MenuTitle, String AllMenu, String place, String Time, int Price) {
  return Padding(
