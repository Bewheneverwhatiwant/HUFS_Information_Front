...
class _GatherDeliveryState extends State<GatherDelivery> {
  ...
  Widget GlobalCampus() {
    return Container(
      child: Column(
        children: [
         ChattingRoomList(context, 2, '엽기떡볶이 드실 분 구합니다', '기숙사 A동', '5000원', 3, '18:25', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트1', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트2', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트3', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트4', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트5', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
        ],
      ),
    );
  }
  ...
  Widget SeoulCampus() {
    return Container(
      child: Column(
        children: [
          ChattingRoomList(context, 2, '서브웨이 같이 먹어용..!', '국제학사', '3500원', 5, '18:00', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트1', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트2', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트3', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
              ChattingRoomList(context, 2, '테스트4', '장소 입력', '가격 입력', 7, '12:34', true, false, TextEditingController()),
