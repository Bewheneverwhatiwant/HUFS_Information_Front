        ...
        children: [
          ListView(
            children: [
              ...
              SizedBox(height: 16),
              ChattingRoomList(
                  3, '바퀴벌레 잡아주세요 ㅠㅠ', '이든하우스', '30000원', 3, '18:25'),
              ChattingRoomList(3, '테스트1', '장소 입력', '가격 입력', 7, '12:34'),
              ChattingRoomList(3, '테스트2', '장소 입력', '가격 입력', 7, '12:34'),
              ChattingRoomList(3, '테스트3', '장소 입력', '가격 입력', 7, '12:34'),
              ChattingRoomList(3, '테스트4', '장소 입력', '가격 입력', 7, '12:34'),
              ChattingRoomList(3, '테스트5', '장소 입력', '가격 입력', 7, '12:34'),
            ],
          ),
