        ...
        Column(children: [
          ...
          Row(
            ...
            children: [
              ...
              Text('스크롤을 내려 개인정보처리방침1을 읽고 동의합니다.')
            ],
          ),
          SizedBox(height: 15),
          Container(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            ...
            Text('스크롤을 내려 개인정보처리방침2를 읽고 동의합니다.')
          ]),
          SizedBox(height: 15),
          Container(
              width: double.infinity,
          ...
          Row(
            ...
            children: [
              ...
              Text('스크롤을 내려 개인정보처리방침3을 읽고 동의합니다.')
            ],
          ),
          Spacer(),
          Container(
