    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          InfoBox(title: '배달비', subtext: '배달비 총액을 기재해주세요.',form: inputForm('원', _costController)),
          InfoBox(title: '수령 장소', subtext: '구성원들과 물품을 나눌 곳을 알려주세요.',form: inputForm('', _placeController)),

          InfoBox(title: '[참고] 최소 희망 인원', subtext: '최소 희망 인원이 충족되지 않아도 시작할 수 있습니다.', form: MinimumPeople()),
          InfoBox(title: '전화번호 공개 여부', subtext: '모임 내 구성원의 전화번호가 모두 공개됩니다.\n노쇼 방지를 위해 서로 주의를 필요로 할 때 유용합니다.', form: OpenSwitch()),
...
class _MinimumPeopleState extends State<MinimumPeople> {
  ...
  @override
  Widget build(BuildContext context) {
    return SelectInput(itemCount: 10, value: selectedValue,
      onChanged: (newValue) {
        setState(() {
          selectedValue =
